...
function BottomTabNavigator(props: {
  ...
  const header = () => <HeaderDropdown env={env} setEnv={setEnv} />;
...
function TabOneNavigator(header: () => JSX.Element, magic: any, web3: any) {
  return (
    <TabOneStack.Navigator>
      <TabOneStack.Screen name="LoginScreen" options={{headerTitle: header}}>
...
function TabTwoNavigator(header: () => JSX.Element, web3: any, magic: any) {
  return (
    <TabTwoStack.Navigator>
      <TabTwoStack.Screen name="Web3Screen" options={{headerTitle: header}}>
