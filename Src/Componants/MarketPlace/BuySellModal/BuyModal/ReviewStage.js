    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.nftInfo}>
                ...
                />
                <View>
                    <Text style={styles.collectionName}>{nftToBuy?.collectionName || 'Collection Name'}</Text>
                    <Text style={styles.nftName}>{nftToBuy?.name || 'NFT Name'}</Text>
                    <Text style={styles.tokenId}>Token ID: {nftToBuy?.tokenId || 'Token ID'}</Text>
                </View>
            </View>
            ...
            {/* Actions */}
            <TouchableOpacity
                style={[styles.button, (notEnoughBalance || !quantity || quantityExceeds) && styles.disabledButton]}
