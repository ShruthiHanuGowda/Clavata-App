...
const EditStage = ({
    ...
    const isDelist = Boolean(
        {
            // Add actual delist logic here
            '0x000...example': true,
        }[nftToSell?.collectionAddress]
    );

    const imageUrl = nftToSell?.image?.thumbnail || 'https://nfts-data.s3.me-central-1.amazonaws.com/wind.jpg';
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.actionContainer}>
                ...
                <TouchableOpacity style={[styles.button, styles.dangerButton]} onPress={continueToRemoveFromMarketStage}>
