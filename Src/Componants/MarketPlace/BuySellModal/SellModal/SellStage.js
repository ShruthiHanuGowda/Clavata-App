...
const SellStage = ({ nftToSell, lowestPrice, continueToNextStage, continueToTransferStage }) => {
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.nftInfo}>
                ...
                />
                <View>
                    <Text style={styles.collectionName}>{nftToSell?.collectionName || 'Collection Name'}</Text>
                    <Text style={styles.nftName}>{nftToSell?.name || 'NFT Name'}</Text>
                    {lowestPrice.toString() && lowestPrice > 0 && (
                        <>
                            <Text style={styles.label}>Lowest Price</Text>
                            <View style={styles.priceRow}>
                                <Image
                                    source={{ uri: 'https://raw.githubusercontent.com/piteasio/app-tokens/main/token-logo/0x15D38573d2feeb82e7ad5187aB8c1D52810B1f07.png' }}
                                    style={styles.icon}
                                />
            ...
            <View style={styles.actionContainer}>
                ...
                <TouchableOpacity style={[styles.button, styles.secondaryButton]} onPress={continueToTransferStage}>
