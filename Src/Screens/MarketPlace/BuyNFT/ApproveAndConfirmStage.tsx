...
const ApproveAndConfirmStage: React.FC<ApproveAndConfirmStageProps> = ({
  ...
  const totalPayment = Number(displayPrice) * (1 + feePercentage) * quantity;
    ...
    <View style={styles.container}>
        ...
        <View style={styles.nftInfo}>
          ...
          <View style={styles.nftDetails}>
            ...
            <Text style={styles.purchaseDetails}>
              {quantity} × {displayPrice.toString()} {paymentCurrency}
            </Text>
          </View>
        </View>
      ...
      <View style={styles.stepsContainer}>
        ...
        <View style={styles.step}>
          ...
          <View style={styles.stepContent}>
            <Text
              style={[styles.stepTitle, !isApproved && styles.inactiveText]}>
              Confirm Purchase
            </Text>
            <Text
              style={[
