                ...
                {currentPrice && lowestPrice && (
                    <View style={styles.comparisonSection}>
                        <Text style={[
                            ...
                            currentPrice > lowestPrice ? styles.aboveFloor : styles.belowFloor
                        ]}>
                            {currentPrice > lowestPrice
                                ? `${((currentPrice - lowestPrice) / lowestPrice * 100).toFixed(1)}% above floor`
                                : currentPrice < lowestPrice
                                    ? `${((lowestPrice - currentPrice) / lowestPrice * 100).toFixed(1)}% below floor`
                                    : 'At floor price'
                            }
                        </Text>
                    </View>
