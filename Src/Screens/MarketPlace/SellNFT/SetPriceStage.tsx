        ...
        <View style={styles.container}>
            ...
            <View style={styles.formSection}>
                ...
                <View style={styles.inputGroup}>
                    ...
                    <View style={[styles.inputContainer, priceIsOutOfRange && styles.inputError]}>
                        <Image
                            source={{
                ...
                <View style={styles.inputGroup}>
                    ...
                    <View style={[styles.inputContainer, qtyIsValid && styles.inputError]}>
                        <TextInput
            ...
            <View style={styles.infoCard}>
                ...
                <Text style={styles.infoText}>
                    • Your NFT will be transferred to the marketplace contract
                </Text>
                <Text style={styles.infoText}>
