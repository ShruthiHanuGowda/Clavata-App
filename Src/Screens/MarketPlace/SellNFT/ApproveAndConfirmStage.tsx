        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>
                    Follow these steps to {variant === 'buy' ? 'purchase' : 'list'} your NFT
                </Text>
            </View>
            ...
            <View style={styles.stepsContainer}>
                ...
                <View style={styles.stepCard}>
                    <View style={styles.stepHeader}>
                        ...
                        <View style={styles.stepContent}>
                            <Text style={[
                                styles.stepTitle,
                                isApproved && styles.completedText
                            ]}>
                            ...
                            <Text style={styles.stepDescription}>
                                {variant === 'buy'
                                    ...
                                    : 'Allow the marketplace to manage your NFT'}
                            </Text>
                        </View>
                    </View>
                    ...
                    {isApproved && (
                        <View style={styles.completedIndicator}>
                            <Text style={styles.completedText}>✓ Contract approved successfully</Text>
                        </View>
                    )}
                </View>
                ...
                <View style={[
                    styles.stepCard,
                    !isApproved && styles.disabledCard
                ]}>
                    <View style={styles.stepHeader}>
                        <View style={[
                            styles.stepNumber,
                        ...
                        <View style={styles.stepContent}>
                            ...
                            <Text style={[
                                ...
                                {variant === 'buy'
                                    ...
                                    : 'Confirm listing your NFT on the marketplace'}
                            </Text>
                        </View>
                    </View>
            ...
            <View style={styles.infoSection}>
                <View style={styles.infoCard}>
                    ...
                    <Text style={styles.infoText}>
                        All transactions are processed on the blockchain. You maintain full control
                        and can cancel at any time before confirmation.
                    </Text>
                </View>
                ...
                <View style={styles.warningCard}>
                    ...
                    <Text style={styles.warningText}>
                        Make sure you have enough ETH in your wallet to cover gas fees for both transactions.
                    </Text>
                </View>
            </View>
        </View>
